...
# TODO: maybe change 28?
FLAGS_rogue_as = args.rogue
ROGUE_AS_NAME = 'R4' # TODO: 4 becomes 6
...
class SimpleTopo(Topo):
    ...
    """
    # TODO: all of this changes
    def __init__(self):
        # Add default members to class.
        super(SimpleTopo, self ).__init__()
        # TODO: this can stay
        num_hosts_per_as = 3
        num_ases = 3 # TODO: 3 becomes 5, I think
		...
		# TODO: this changes to fit the topology. This ads 1 to 2 and 2 to 3
		# make sure it's in the right order... may just want to do it manually
        for i in xrange(num_ases-1):
            self.addLink('R%d' % (i+1), 'R%d' % (i+2))
		
		# TODO: change this to proper rogue AS
        routers.append(self.addSwitch('R4')) # TODO: R4 changes
        for j in xrange(num_hosts_per_as):
            hostname = 'h%d-%d' % (4, j+1) # TODO: 4 changes
            host = self.addNode(hostname)
            hosts.append(host)
            self.addLink('R4', hostname) # TODO: R4 changes
        # This MUST be added at the end
        self.addLink('R1', 'R4') # TODO: routers change
        return
...
def getIP(hostname):
    ...
    AS = int(AS)
    if AS == 4: # TODO: 4 becomes 6
        AS = 3 # TODO: 3 becomes 1
    ip = '%s.0.%s.1/24' % (10+AS, idx) # TODO: change this to match IP address
    return ip
...
def getGateway(hostname):
    ...
    if AS == 4: # TODO: 4 becomes 6
        AS = 3 # TODO: 3 becomes 1
    gw = '%s.0.%s.254' % (10+AS, idx) # TODO: change this to match IP address
    return gw
...
def main():
    ...
    startWebserver(net, 'h3-1', "Default web server") # TODO: 3 becomes 1
    startWebserver(net, 'h4-1', "*** Attacker web server ***") # TODO: 4 becomes 6
